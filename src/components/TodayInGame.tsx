...
function MatchCard({ m }: { m: TodayMatch }) {
  ...
  return (
    <div className="glass glass-hover flex flex-col p-4">
      ...
      <div className="mt-3.5 space-y-1.5 border-t border-black/5 dark:border-white/10 pt-3">
      ...
      <div className="mt-3 flex items-center justify-between border-t border-black/5 dark:border-white/10 pt-2.5 text-[12px]">
      ...
      {m.impact && (
        <div className="mt-2.5 rounded-xl bg-white/55 px-3 py-2 text-[12px] leading-snug text-ink-soft ring-1 ring-black/5 dark:bg-white/8 dark:ring-white/12">
          {m.impact}
        </div>
      )}
    </div>
...
export function TodayInGame({
  ...
  return (
    <div>
      ...
      {riser?.condition && (
        <div className="mt-3 flex items-center gap-2 rounded-2xl bg-white/55 px-4 py-3 text-[13px] ring-1 ring-black/5 dark:bg-white/8 dark:ring-white/12">
